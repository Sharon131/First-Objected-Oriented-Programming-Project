...
public class Vector2dTest {
    ...
    public void testAdd(){
        ...
        assertEquals(testVector1.add(testVector2), new Vector2d(3, -1));
    }
    ...
    public void testSubtract(){
        ...
        assertEquals(testVector1.subtract(testVector2), new Vector2d(-1, -1));
    }
    ...
    public void testOpposite(){
        ...
        assertEquals(testVector1.opposite(), new Vector2d(-1, 1));
    }
}
